...
- Chroma Strata: **preview zoom** (fit / 100–200%); **`tintComposite` multiply** for colors 2–4 + pattern + color 6; **`constantsBlend`** for lineart / infoLayer; **full-width preview hero** above controls; **Palette** layer + **three patterns** in Asagi manifest; compose order Background → Palette → Info.
