...
- Chroma Strata: **preview zoom** (fit / 100–200%); **`tintComposite` multiply** for colors 2–4 + pattern + color 6 (offscreen tint slab); **`constantsBlend`** for lineart / infoLayer (e.g. multiply, soft-light); Asagi **patterns** trimmed to Pattern1 only in manifest.
